...
const STRIPE_JOBS_URL = "https://stripe.com/jobs/search?teams=Infrastructure+%26+Corporate+Tech&teams=Machine+Learning&teams=Tech+Programs&remote_locations=Latin+America--Argentina+Remote";
const DEFAULT_PAGE_SIZE = 20;
const REQUEST_RETRIES = 3;
const REQUEST_TIMEOUT_MS = 15_000;
const rateLimiter = new DomainRateLimiter(2_500);
export class StripeScraper {
    source = "Stripe";
...
async function fetchStripeJobsHtml(url) {
